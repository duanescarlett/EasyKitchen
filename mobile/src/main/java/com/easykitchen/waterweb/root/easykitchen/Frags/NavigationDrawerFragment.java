...
public class NavigationDrawerFragment extends Fragment {
    ...
    private static final String PREF_FILE_NAME = "testing";
    private static final String KEY_USER_LEARNED_DRAWER = "user learned";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        // Indicate that this fragment would like to influence the
        // set of actions in the action bar.
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(
            ...
            public void onDrawerSlide(View drawerView, float slideOffset){
                if(slideOffset < 0.6){
                    toolbar.setAlpha(5 - slideOffset);
                }
            }
        };
